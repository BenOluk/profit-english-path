...
const EventCTASection = () => {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-background to-card relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-highlight-orange font-bold mb-2">
